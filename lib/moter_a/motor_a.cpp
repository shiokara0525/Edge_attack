...
void motor_attack::moveMoter_L(angle ang,int val,double ac_val,LINE line){  //モーター制御する関数
...
void motor_attack::moveMoter_0(angle ang,int val,double ac_val){
  double g = 0;                //モーターの最終的に出る最終的な値の比の基準になる値
  double h = 0;
  double Mval[4] = {0,0,0,0};  //モーターの値×4
  double max_val = val;        //モーターの値の上限値
